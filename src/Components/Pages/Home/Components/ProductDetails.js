...
const ProductDetails = () => {
  ...
  console.log(categoryName, categoryProductName, productName)
                          ...
                          categoryName === 'groceries' ? (
                            <p className='py-2'>
                              ...
                              <div className='item-weight'>
                                {
                                list.weight.length > 0 && list.weight.map((num, i) => <span key={i} className='item-style' >{num}g</span>)
                                }
                              </div>
                            </p>
                          ) : (
                            categoryName === 'Electronics' ? (
                              <p className='py-2'>
                                ...
                                <div className='item-weight'>
                                  {
                                  list.RAM.length > 0 && list.RAM.map((num, i) => <span key={i} className='item-style'>{num}GB</span>)
                                  }
                                </div>
                              </p>
                            ) : (
                              categoryName === 'Fashion' ? (
                                <p className='py-2'>
                                  ...
                                  <div className='item-weight'>
                                    {
                                    list.SIZE.length > 0 && list.SIZE.map((num, i) => <span key={i} className='item-style'>{num}</span>)
                                    }
                                  </div>
                                </p>
                              ) : null
